    ...
    <div class="p-6">
        <div class="flex flex-col sm:flex-row justify-between gap-4 mb-4">
            ...
            <div class="w-full sm:w-1/3">
                <label for="filter-department" class="block text-sm font-medium text-gray-700 mb-1">Filter by Department</label>
                <select id="filter-department" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border">
            ...
            <div class="w-full sm:w-1/3">
                ...
                <select id="filter-status" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border">
            ...
            columns: [
                ...
                { data: 'subject', name: 'subject' },
                {
                    ...
                    render: function(data, type, row) {
                        return '<div class="flex flex-col"><span class="font-medium text-gray-900">' + data + '</span><span class="text-xs text-gray-500">' + row.customer_email + '</span></div>';
                    }
                },
